...
const AdminSchedulePage = () => {
  ...
  // Format date for comparison (local date string)
  ...
  // Get all unique time slots from ALL sessions (not just visible ones)
  // so the time grid is consistent
  ...
  // Stats: use all sessions for totals, visible sessions for current week view
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Dynamic week range label — shows actual dates, clicking returns to today */}
          <Button
      ...
      <div className="flex items-center gap-6 text-sm">
        ...
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded bg-muted/20 border border-dashed border-border opacity-60"></div>
